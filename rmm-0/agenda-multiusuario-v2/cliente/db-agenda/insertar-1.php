<?php
/**
 * RMM-0 - Agenda multiusuario (Cliente) - db-agenda/insertar-1.php
 *
...
cabecera("Tabla Agenda - Añadir 1", MENU_TABLA_AGENDA, 1);

$consulta = http_build_query([
    "accion"  => "agenda-comprobar-limite-registros"
]);
...
if ($respuesta["resultado"] == KO) {
    ...
    print "\n";
    print "      <p>\n";
    print "        <input type=\"hidden\" name=\"accion\" value=\"agenda-insertar-registro\">\n";
