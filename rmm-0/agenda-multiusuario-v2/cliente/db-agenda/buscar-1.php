<?php
/**
 * RMM-0 - Agenda multiusuario (Cliente) - db-agenda/buscar-1.php
 *
...
cabecera("Tabla Agenda - Buscar 1", MENU_TABLA_AGENDA, 1);

$consulta = http_build_query([
    "accion"  => "agenda-contar-registros-todos",
]);
...
if ($respuesta["resultado"] == KO) {
    ...
    print "\n";
    print "      <p>\n";
    print "        <input type=\"hidden\" name=\"accion\" value=\"agenda-buscar-registros\" />\n";
