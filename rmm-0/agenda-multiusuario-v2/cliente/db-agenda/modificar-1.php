<?php
/**
 * RMM-0 - Agenda multiusuario (Cliente) - db-agenda/modificar-1.php
 *
...
if ($respuesta["resultado"] == KO) {
    ...
    print "\n";
    print "      <p>\n";
    print "        <input type=\"hidden\" name=\"accion\" value=\"agenda-seleccionar-registro-id\">\n";
