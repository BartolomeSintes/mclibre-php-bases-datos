<?php
/**
 * RMM-0 - Agenda multiusuario (Cliente) - db-agenda/borrar-1.php
 *
...
cabecera("Tabla Agenda - Borrar 1", MENU_TABLA_AGENDA, 1);
...
if ($respuesta["resultado"] == KO) {
    print "    <p class=\"aviso\">{$respuesta["mensajes"][0]["texto"]}</p>\n";
        ...
        print "\n";
        print "      <p>\n";
        print "        <input type=\"hidden\" name=\"accion\" value=\"agenda-borrar-registros-id\" />\n";
