...
[$autor, $password, $nivel] = compruebaAvisosIndividuales("buscar-2", "usuarios", "usuario", "password", "nivel");

compruebaAvisosGenerales("buscar-2", "registrosNoEncontrados", "usuarios", "usuario", "password", "nivel");
